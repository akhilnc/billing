...
namespace billing.Data.Migrations
{
    ...
    [Migration("20220118064852_addedCompanySettingsTable")]
    partial class addedCompanySettingsTable
    {
            ...
            modelBuilder.Entity("billing.Data.Models.MstUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "test",
                            CreatedOn = new DateTime(2022, 1, 18, 12, 18, 52, 235, DateTimeKind.Local).AddTicks(67),
                            IsActive = true,
                            ModifiedBy = "asda",
                            ModifiedOn = new DateTime(2022, 1, 18, 12, 18, 52, 236, DateTimeKind.Local).AddTicks(1220),
                            Name = "admin",
                            ShortName = "Ad",
                            UId = "2763f39c-4b77-47f0-8b3d-9c260eff98fd"
                        });
                });
