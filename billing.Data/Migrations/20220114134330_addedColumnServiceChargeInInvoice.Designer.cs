...
namespace billing.Data.Migrations
{
    ...
    [Migration("20220114134330_addedColumnServiceChargeInInvoice")]
    partial class addedColumnServiceChargeInInvoice
    {
            ...
            modelBuilder.Entity("billing.Data.Models.MstUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "test",
                            CreatedOn = new DateTime(2022, 1, 14, 19, 13, 29, 499, DateTimeKind.Local).AddTicks(2778),
                            IsActive = true,
                            ModifiedBy = "asda",
                            ModifiedOn = new DateTime(2022, 1, 14, 19, 13, 29, 500, DateTimeKind.Local).AddTicks(3607),
                            Name = "admin",
                            ShortName = "Ad",
                            UId = "d49648f6-6ccd-495b-88cb-b9dfa3c1a066"
                        });
                });
